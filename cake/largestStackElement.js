...
var MaxStackInstance = new MaxStack();


MaxStackInstance.push(4);
MaxStackInstance.push(10);
MaxStackInstance.push(15);
MaxStackInstance.push(16);

console.log(MaxStackInstance.getMax());
MaxStackInstance.pop();
...
MaxStackInstance.push(3);
console.log(MaxStackInstance.getMax());


MaxStackInstance.push(0);
MaxStackInstance.push(1);
console.log(MaxStackInstance.getMax());
